<%-- 
    Document   : Provider_Reg
    Created on : 17 Feb, 2025, 4:57:15 PM
...
<html lang="en">
    ...
    <body class="index-page">
                ...
                <div class="container position-relative d-flex align-items-center justify-content-between">
                    ...
                    <nav id="navmenu" class="navmenu">
                        <ul>
                            ...
                            <li class="dropdown"><a class="active" href="#"><span>Provider</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
                                <ul>
                            ...
                            <li class="dropdown"><a href="#"><span>Consumer</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
                                <ul>
        ...
        <h2 class="header-title">Provider Register</h2>
        <div class="formbold-main-wrapper">
            <div class="formbold-form-wrapper">
                <form action="Provider_Reg" method="POST" enctype="multipart/form-data">
                    <!-- User Name -->
                    <div class="formbold-mb-3">
                        <div>
                            <label for="name" class="formbold-form-label">Provider Name:</label>
                            <input type="text" id="name" name="Provider_Name" placeholder="Enter your name" class="formbold-form-input" required>
                        </div>
                    </div>
