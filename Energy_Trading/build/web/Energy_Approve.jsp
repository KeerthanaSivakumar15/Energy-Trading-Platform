<%-- 
    Document   : Energy_Approve
    Created on : 18 Feb, 2025, 1:01:58 PM    
--%>
    ...
    <body class="index-page">
        ...
        <header id="header" class="header fixed-top">
            ...
            <ul>
                ...
                <li><a href="Energy_Approve.jsp" class="active">Energy Approval</a></li>  
       ...
       <h2 class="header-title">Energy Approval</h2>
        <%
            Dbconnection db1 = new Dbconnection();
            String query = "select * from upload_energy where Sts='NO'";
            ResultSet rs = db1.Select(query);
            while (rs.next()) {
        %>
       <div class="card1">
           <div class="card1-image">
            <img src="Energy_Img.jsp?name=<%=rs.getInt("UE_Id")%>" class="card-img-top" alt="Profile Picture" width="200px" height="250px">
            </div>
             <div class="card1-content">                
                 <p class="card-text">
                     
                    <strong>Provider Name:</strong><%= rs.getString("Provider_Name") %><br> 
                    <strong>Energy Type:</strong><%= rs.getString("Energy_Type") %><br> 
                    <strong>Price:</strong> <%= rs.getString("Price") %><br>
                    <strong>Quantity:</strong> <%= rs.getString("Quantity") %><br>
                    <strong>Address:</strong><%= rs.getString("Provider_Address") %><br>                                       
                </p>
                <a href="Request3.jsp?UE_Id=<%= rs.getString("UE_Id") %>" class="btn btn-success">Approved</a>
                <a href="Request4.jsp?UE_Id=<%= rs.getString("UE_Id") %>" class="btn btn-danger">Rejected</a>
            </div>           
        </div>
        <%
            }
