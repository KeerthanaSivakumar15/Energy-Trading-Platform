<%-- 
    Document   : Consumer_Approve
    Created on : 18 Mar, 2025, 3:35:17 PM    
--%>
...
<html lang="en">
    ...
    <body class="index-page">
        ...
        <header id="header" class="header fixed-top">
            ...
            <ul>
               <li><a href="Admin_Home.jsp" >Home</a></li>
                ...
                <li><a href="Consumer_Approve.jsp" class="active">Consumer Approval</a></li>
       ...
       <h2 class="header-title">Consumer Approval</h2>
        <%
            Dbconnection db1 = new Dbconnection();
            String query = "select * from consumer_register where Admin_Sts='NO'";
            ResultSet rs = db1.Select(query);
            while (rs.next()) {
        %>
       <div class="card1">
           <div class="card1-image">
            <img src="Consumer_Img.jsp?name=<%=rs.getInt("CR_Id")%>" class="card-img-top" alt="Profile Picture" width="200px" height="250px">
            </div>
             <div class="card1-content">                
                 <p class="card-text">                     
                    <strong>Consumer Name: </strong><%= rs.getString("Consumer_Name") %><br> 
                ...
                <a href="Request5.jsp?CR_Id=<%= rs.getString("CR_Id") %>" class="btn btn-success">Approved</a>
                <a href="Request6.jsp?CR_Id=<%= rs.getString("CR_Id") %>" class="btn btn-danger">Rejected</a>
            </div>           
        </div>
        <%
            }
