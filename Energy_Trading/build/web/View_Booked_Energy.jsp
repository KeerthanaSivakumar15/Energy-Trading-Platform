<%-- 
    Document   : View_Booked_Energy
    Created on : 15 Mar, 2025, 5:46:54 PM
        ...
        <main class="main">
          ...
          <div class="container">
            <h2 class="my-4 text-center text-success">
                <i class="fas fa-bolt"></i> Booked Energy
            </h2>

            <div class="row">
                <%
                    try {
                        ResultSet ts = db.Select("SELECT * FROM book_energy WHERE Provider_Id='" + id + "'");
                        boolean hasBookings = false;

                        while (ts.next()) {
                            hasBookings = true;
                            String energyId = ts.getString("Energy_Id");
                            String providerName = ts.getString("Consumer_Id");
                ...
                <div class="col-12">
                    <div class="card shadow-lg border-0 animate__animated animate__fadeInUp d-flex flex-row align-items-center">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                <strong><i class="fas fa-user"></i> Consumer ID:</strong> <%= providerName%>
                            </p>
                            <p class="card-text">
            ...
            function Review(energyId){
                window.location.href='Provider_View_Review.jsp?Energy_Id='+energyId;
            }
            </script>
