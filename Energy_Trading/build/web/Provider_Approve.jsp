<%-- 
    Document   : Provider_Approve
    Created on : 18 Feb, 2025, 12:52:04 PM    
--%>
    ...
    <body class="index-page">
        ...
        <header id="header" class="header fixed-top">
            ...
            <ul>
                ...
                <li><a href="Provider_Approve.jsp" class="active">Provider Approval</a></li>  
        ...
        <h2 class="header-title">Provider Approval</h2>
        <%
            Dbconnection db1 = new Dbconnection();
            String query = "select * from provider_register where Sts='NO'";
            ResultSet rs = db1.Select(query);
            while (rs.next()) {
        %>
       <div class="card1">
           <div class="card1-image">
            <img src="Provider_Img.jsp?name=<%=rs.getInt("PR_Id")%>" class="card-img-top" alt="Profile Picture" width="200px" height="250px">
            </div>
             <div class="card1-content">                
                 <p class="card-text">
                     
                    <strong>Provider Name:</strong><%= rs.getString("Provider_Name") %><br>         
                    <strong>Mobile No:</strong> <%= rs.getString("Contact") %><br>
                    <strong>Address:</strong><%= rs.getString("Address") %><br>                                       
                </p>
                <a href="Request1.jsp?PR_Id=<%= rs.getString("PR_Id") %>" class="btn btn-success">Approved</a>
                <a href="Request2.jsp?PR_Id=<%= rs.getString("PR_Id") %>" class="btn btn-danger">Rejected</a>
            </div>           
        </div>
        <%
            }
