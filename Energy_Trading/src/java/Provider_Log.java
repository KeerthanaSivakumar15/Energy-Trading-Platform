...
@WebServlet(urlPatterns = {"/Provider_Log"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (email.equals(sessionEmail) && Integer.parseInt(enteredOtp) == sessionOtp) {
                ...
                String query = "SELECT * FROM provider_register WHERE Email='" + email + "' AND Password='" + password + "'";
            ...
            {                   
                    ...
                    response.sendRedirect("Provider_Log.jsp");
                }
            } 
