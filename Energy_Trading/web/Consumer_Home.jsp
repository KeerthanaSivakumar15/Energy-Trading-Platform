<%-- 
    Document   : Consumer_Home
    Created on : 12 Mar, 2025, 2:53:17 PM    
--%>
            ...
            <div class="branding d-flex align-items-center">
                ...
                <div class="container position-relative d-flex align-items-center justify-content-between">
                    ...
                    <nav id="navmenu" class="navmenu">
                        <ul>
                            <li><a href="Consumer_Home.jsp" class="active">Home</a></li>                                     
            ...
            <%
                ...
                if (id != null && name != null) {
                    try {
                        ...
                        if (rs.next()) {
                            String User_Name = rs.getString("Consumer_Name");
                            String User_Id = rs.getString("CR_Id");
