<%-- 
    Document   : Provider_Account
    Created on : 18 Feb, 2025, 12:00:22 PM
                ...
                <div class="container position-relative d-flex align-items-center justify-content-between">
                    ...
                    <nav id="navmenu" class="navmenu">
                        <ul>
                            ...
                            <li><a href="Provider_Account.jsp" class="active">Add Account</a></li>
...
<div class="formbold-main-wrapper">
    <div class="formbold-form-wrapper">
        <form id="addAccountForm" action="Provider_Account" method="POST" enctype="multipart/form-data" onsubmit="return Validate_Data(true)">
            <!-- Card Type -->
