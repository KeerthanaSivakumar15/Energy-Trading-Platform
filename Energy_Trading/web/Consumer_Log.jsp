<%-- 
    Document   : Consumer_Log
    Created on : 12 Mar, 2025, 1:53:36 PM
...
<html lang="en">
    ...
    <h2 class="header-title">Consumer Login</h2>
  ...
  <div class="formbold-form-wrapper">
    ...
    <form action="Consumer_Log" method="post" >      
      <div class="formbold-mb-3">
        <div>
