<%-- 
    ...
    Created on : 12 Mar, 2025, 4:37:05 PM
    Author     : trios
--%>
                ...
                <div class="container position-relative d-flex align-items-center justify-content-between">
                   ...
                   <nav id="navmenu" class="navmenu">
                        <ul>
                            ...
                            <li><a href="View_Account.jsp" class="active">Account Details</a></li>
       ...
       <%
            ...
            if (id != null && name != null) {
                try {
                    ...
                    if (rs.next()) {
                        String Provider_Name = rs.getString("Consumer_Name");
                        String PR_Id = rs.getString("CR_Id");
        ...
        <h2 class="header-title">Your Accounts</h2>
         ...
         <%
                        ResultSet ts = db.Select("SELECT * FROM consumer_account WHERE CR_Id='" + id + "'");
                        while (ts.next()) {
                            ...
                            String accountId = ts.getString("CA_Id");
