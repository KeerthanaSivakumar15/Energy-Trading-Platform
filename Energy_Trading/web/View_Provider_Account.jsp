<%-- 
    Document   : View_Provider_Account
    Created on : 24 Feb, 2025, 2:15:51 PM
...
<html lang="en">
    ...
    <style>
       /* Parent container that holds the card */
...
.credit-card {
  ...
  padding: 17px;   
     position: relative;
    background: linear-gradient(135deg, #0f6efd, #2a2a72); /* Blue gradient */
    border-radius: 10px;
  ...
  .hero .carousel{
    ...
    <body class="index-page">
                ...
                <div class="container position-relative d-flex align-items-center justify-content-between">
                    ...
                    <nav id="navmenu" class="navmenu">
                        <ul>
                            ...
                            <li><a href="View_Provider_Account.jsp" class="active">Account Details</a></li>
       ...
       <%
        ...
        <h2 class="header-title">Your Accounts</h2>

        
        
        
         <%
                        ResultSet ts = db.Select("SELECT * FROM provider_account WHERE PR_Id='" + id + "'");
                        while (ts.next()) {
                            String Card_Type = ts.getString("Card_Type");
                            String Card_Number = ts.getString("Card_Number");
                            String Cardholder_Name = ts.getString("Cardholder_Name");
                            String Card = ts.getString("Cards");
                            String accountId = ts.getString("PA_Id");
                            String Amount = ts.getString("Amount");
                    %>

                   <div class="credit-card">    
    <div class="card-details">
        <p class="card-type"><strong>Card Type:</strong> <%= Card_Type%></p>
        <p><strong>Card Number:</strong> <%= Card_Number%></p>
        <p><strong>Card Holder Name:</strong> <%= Cardholder_Name%></p>
